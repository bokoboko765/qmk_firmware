 ...
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LCtrl | LGui |paste |  ~L2 | LAlt |                                       | kana |RCtrl | Left | Down | Right|
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | ~L2  | cut  |       | Ins  | Del  |
 *                                 ,------|------|------|       |------+--------+------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        KC_Z,         KC_X,        KC_C,      KC_V,   KC_B,   LCTL(KC_V),
        KC_LCTRL,       KC_LGUI,      LCTL(KC_V),LT(NUM,KC_TRNS),KC_LALT,
        ...
        // right hand
             ...
             KC_ASTR,      KC_N,   KC_M,   KC_COMM,KC_DOT, KC_UP,            LT(FN,KC_QUOT),
                                  LALT(KC_GRV), KC_RCTL,KC_LEFT,KC_DOWN,          KC_RGHT,
             KC_INS,         KC_DELT,
             KC_TRNS,
 ...
 * | Tab    |      |      |      |      |      |      |           |      | -_   |  7&  |  8*  |  9(  |  *   |   -    |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * |        |C/S/F5|C/S/F6|C/S/F3|C/S/F4|      |------|           |------|  -   |  4$  |  5%  |  6^  |  +   |  =+    |
 * |--------+------+------+------+------+------|LShift|           |      |------+------+------+------+------+--------|
 * | LShift |      |      |LShift|      |      |      |           |      |  &   |  1!  |  2@  |  3#  |  \   | Enter  |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |LCtrl |      |      |      | LAlt |                                       |  0   |  ,<  |  .>  |      |      |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
...
[NUM] = KEYMAP(
       ...
       KC_TRNS,     LCTL(LSFT(KC_F5)),LCTL(LSFT(KC_F6)),LCTL(LSFT(KC_F3)),LCTL(LSFT(KC_F4)), KC_TRNS,
       KC_LSFT,     KC_TRNS,    KC_TRNS, KC_LSFT, KC_TRNS, KC_TRNS, KC_LSFT,
